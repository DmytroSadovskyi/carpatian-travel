import { careerInfo } from '@/lib/careerInfo';
import CareerForm from '../../components/CareerForm';

export default function Career() {
  return (
    <section
      className="bg-background-career md:bg-careerTab lg:bg-careerDesc bg-cover bg-center smMax:py-0 md:py-[64px] lg:py-[104px]"
      id="career"
    >
