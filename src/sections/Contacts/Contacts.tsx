...
export default function Contacts() {
  return (
    <section className="bg-background-contacts bg-contacts bg-cover bg-center bg-no-repeat md:bg-contactsTab lg:bg-contactsDesc py-[54px] md:py-[64px] lg:py-[104px]" id="contacts">
            ...
            <div>
              <div className="flex flex-row gap-5 mb-6 text-sm md:text-base lg:text-[18px] lg:leading-[1.3] lg:mb-16 ">
                <div className="flex flex-col ml-[25px]  md:ml-[64px] lg:ml-[141px]">
                  <a href="tel:+38(098)1234567" className="smMax:leading-[1.7]">
                    +38 (098) 12 34 567
                  </a>
                  <a href="tel:+38(073)1234567" className="smMax:leading-[1.7]">
                    +38 (073) 12 34 567
                  </a>
                </div>
