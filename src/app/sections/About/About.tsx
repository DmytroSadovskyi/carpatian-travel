...
export default function About() {
  return (
    <section
      ...
      className="py-[54px] md:py-[64px]  lg:py-[104px]"
    >
      <div className="container grid gap-2 md:grid-cols-[218px_266px_220px] md:grid-rows-[295px_215px_117px] md:gap-x-0 md:gap-y-4 lg:grid-cols-[50%_25%_25%] lg:grid-rows-[250px_192px_120px]">
        ...
        <p className="text-left w-[180px] font-thin text-sm mb-[20px] md:w-full md:col-start-3 md:mb-0 md:text-base leading-5 lg:col-start-2 lg:text-lg lg:leading-6 lg:pl-[24px] lg:pt-[6px]">
        ...
        <p className="text-left w-[180px] font-thin text-sm mb-[40px] md:w-full md:col-start-3 md:mb-0 md:text-base leading-5 lg:col-start-2 lg:text-lg lg:leading-6 lg:pl-[24px]">
        ...
        <div className="font-thin mb-[40px]  justify-self-end  md:row-start-2 md:self-end md:mb-0 md:pt-[70px] md:text-base leading-5 lg:row-start-3 lg:col-start-3">
        ...
        <p className="font-thin text-sm text-justify md:text-base leading-5 md:w-[463px] md:row-start-3 md:col-start-2 md:self-end lg:col-start-1 lg-col-end-2">
